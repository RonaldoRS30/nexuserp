...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-5 z-40 inline-flex h-12 w-12 items-center justify-center rounded-sm bg-[#128C7E] text-white shadow-panel transition-transform hover:scale-[1.04]"
